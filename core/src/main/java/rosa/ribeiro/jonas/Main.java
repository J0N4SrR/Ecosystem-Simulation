...
import rosa.ribeiro.jonas.resouces.Plant;
...
// --- PREYS ---
        ...
        Resource arbusto = new Plant("Arbusto Nutritivo", new Coordinate(-5, -5));
        Resource moita = new Plant("Moita Densa", new Coordinate(5, 0));
        Resource gramado = new Plant("Gramado Verdejante", new Coordinate(-2, -3));
        Resource clareira = new Plant("Clareira de Ervas", new Coordinate(3, -4));

        resources.add(arbusto);
        resources.add(moita);
        resources.add(gramado);
        resources.add(clareira);
        resources.add(lago);
